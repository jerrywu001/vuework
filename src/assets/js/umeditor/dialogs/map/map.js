(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        tpl: "<style type=\"text/css\">" +
            ...
            "<td><label class=\"edui-map-dynamic-label\"><input style=\"position: relative; left: 0px; opacity: 1; font-size: 12px;\" class=\"edui-map-dynamic\" type=\"checkbox\" name=\"edui-map-dynamic\" /><span style=\"font-size: 12px;\"><%=lang_dynamicmap%></span></label></td>"+
            "</tr>" +
            "</table>" +
                ...
                exec: function (editor) {
                    ...
                    if (widget.root().find(".edui-map-dynamic")[0].checked) {
                        ...
                        url = "http://api.map.baidu.com/staticimage?center=" + center.lng + ',' + center.lat +
                            "&zoom=" + zoom + "&width=" + size.width + '&height=' + size.height + "&markers=" + center.lng + ',' + center.lat;
